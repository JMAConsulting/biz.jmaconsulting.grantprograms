...
CREATE TABLE IF NOT EXISTS `civicrm_payment` (
  ...
  `financial_trxn_id` int(10) unsigned NOT NULL COMMENT 'Financial Trxn ID',
  ...
  `replaces_check_number` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Replaced Check Number',
  PRIMARY KEY (`id`)
