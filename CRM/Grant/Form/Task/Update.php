...
class CRM_Grant_Form_Task_Update extends CRM_Grant_Form_Task 
{
    ...
    function buildQuickForm( ) 
    {
        ...
        $this->addElement('select', 'status_id', ts('Grant Status'), array( '' => ts( '- select -' )  ) + $grantStatus);
        ...
        //$this->assign( 'elements', array( 'status_id', 'other_amount', 'amount_total', 'decision_date' ) );
